...
public enum ErrorCode {
    ...
    TASK_008("ERR-TASK-008", HttpStatus.BAD_REQUEST, "タスクを作成するチームを指定してください"),
    TASK_009("ERR-TASK-009", HttpStatus.FORBIDDEN, "指定されたチームの操作権限がありません"),
    TASK_010("ERR-TASK-010", HttpStatus.BAD_REQUEST, "担当者はチームメンバーから選択してください"),

    TEAM_001("ERR-TEAM-001", HttpStatus.BAD_REQUEST, "チーム入力内容に誤りがあります"),
    TEAM_002("ERR-TEAM-002", HttpStatus.CONFLICT, "同じ名前のチームが既に存在します"),
    TEAM_003("ERR-TEAM-003", HttpStatus.FORBIDDEN, "このチームにアクセスする権限がありません"),
    TEAM_004("ERR-TEAM-004", HttpStatus.NOT_FOUND, "対象のチームが存在しません"),

    TEAM_MEMBER_001("ERR-TEAM-MEMBER-001", HttpStatus.BAD_REQUEST, "メンバー入力内容に誤りがあります"),
    TEAM_MEMBER_002("ERR-TEAM-MEMBER-002", HttpStatus.FORBIDDEN, "メンバー追加権限がありません"),
    TEAM_MEMBER_003("ERR-TEAM-MEMBER-003", HttpStatus.CONFLICT, "対象ユーザーは既にチームに所属しています"),
    TEAM_MEMBER_004("ERR-TEAM-MEMBER-004", HttpStatus.BAD_REQUEST, "指定されたロールが不正です"),
    TEAM_MEMBER_005("ERR-TEAM-MEMBER-005", HttpStatus.FORBIDDEN, "ロール変更権限がありません"),
    TEAM_MEMBER_006("ERR-TEAM-MEMBER-006", HttpStatus.FORBIDDEN, "OWNERのロールは変更できません"),
    TEAM_MEMBER_007("ERR-TEAM-MEMBER-007", HttpStatus.NOT_FOUND, "対象のメンバーが存在しません"),
    TEAM_MEMBER_008("ERR-TEAM-MEMBER-008", HttpStatus.FORBIDDEN, "メンバー削除権限がありません"),
    TEAM_MEMBER_009("ERR-TEAM-MEMBER-009", HttpStatus.FORBIDDEN, "OWNERは削除できません"),
    TEAM_MEMBER_010("ERR-TEAM-MEMBER-010", HttpStatus.CONFLICT, "担当中のタスクがあるため、このメンバーを削除できません"),

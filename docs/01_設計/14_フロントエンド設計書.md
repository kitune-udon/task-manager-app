...
| action | handleShowList, handleShowCreate, handleShowDetail, handleShowEdit, clearTaskStateOnLogout |
...
| 添付ファイル機能 | TaskDetail / TaskForm 周辺にアップロードUI追加が必要。取得系と更新系で hook 分離を維持する |
